...
angular.module("djds4rce.angular-socialshare", []).factory("$FB", ["$window", function(t) {
        ...
        init: function(e) {
            ...
            this.fbId = e, t.fbAsyncInit = function() {
                ...
                function(t) {
                    ...
                    t.getElementById(n) || (e = t.createElement("script"), e.id = n, e.async = !0, e.src = "//connect.facebook.net/en_US/sdk.js", i.parentNode.insertBefore(e, i))
                }(document)
        }
    }
    ...
    return {
        ...
        link: function(e, n, i) {
            i.$observe("url", function() {
                i.shares && i.url && t.get("https://graph.facebook.com/v2.7/?id=" + i.url + "&access_token=1616900588585152|5914bafac2dd7988e0c8938b63c5bab7").success(function(t) {
                	var n;
                    if(t.share!=undefined)
                    {
                    	n = t.share.share_count.toString();
                    }
                    else{
                    	n = 0;
                    }
    ...
    return {
        template: '<a href="{{href}}" data-pin-do="{{pinDo}}" data-pin-config="{{pinConfig}}"><img src="//assets.pinterest.com/assets/pidgets/pinit_fg_en_rect_gray_20.png" /></a>',
        link: function(n, i, o) {
